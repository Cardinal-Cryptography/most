...
async function main() {
    ...
    console.log("wETH [", addresses.weth, "]", "balance of:", accounts[0], ":", balance);
    ...
    console.log("Requesting transfer of", amount, "units of", addresses.weth, "to", receiver);
    let tx_response =  await most.sendRequest(srcTokenAddress, amount, destReceiverAddress);
    console.log("Tx hash:", tx_response.tx, ", block number:", tx_response.receipt.blockNumber);
